...
%% model, PI, from 1850-2025
load('Rx1day_ecdf_25dg_lon180_landmean_noAntarctica_1850_2025.mat')
series_model_region=global_PI_model;
...
model_num=1:size(PI_smooth_ref,2);
scale_m=1;
Nres=99;
for t=1:length(model_num)
    ...
    %% save data
    post_all(:,:,t) = post_all_t;
    prior(:,:,t)=mo_da_fu;
    pseudo_obs(:,t)=pseudo_obs_select;

end
save('F:\data_code\output\PI_global_GSATconstraint_1850_2025_IPMtest.mat', 'post_all', 'prior','pseudo_obs','common_models');
